# README — archived long form (2026-09-23)

> **This is the pre-2026-09-23 version of the repo [`README.md`](../README.md)**, kept verbatim for reference. It was restructured after the feedback in disc #498. Model lists, numbers and recommendations below are **frozen and out of date**; the live README and the card pages are current. Relative links below were written for the repo root and may not resolve from `docs/`.
