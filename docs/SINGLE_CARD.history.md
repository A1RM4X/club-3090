# SINGLE_CARD — archived long form (2026-09-23)

> **This is the pre-2026-09-23 version of [`SINGLE_CARD.md`](SINGLE_CARD.md), kept for its derivations and forensics.** The live page was rewritten around a registry-generated slug table (disc #498). Slug lists, statuses and recommendations below are **frozen at their last update (2026-08-21) and out of date**; use the live page for what to run.
